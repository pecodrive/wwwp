...
nnoremap <silent> <Plug>(vimshell_split_create) :call vimshell#create_shell(1, '')
nnoremap <silent> <Plug>(vimshell_split_switch) :call vimshell#switch_shell(1, '')
...
silent only
cd ~/Documents/project/mother/var/www/html/wp-content/themes/matome
...
badd +0 404.php
badd +0 adspace.php
badd +0 archivelist.php
badd +0 articlelist.php
badd +0 category.php
badd +0 categoryarchive.php
badd +0 categorylist.php
badd +0 footer.php
badd +0 form.php
badd +0 formajax.php
...
argadd 404.php
argadd adspace.php
argadd archivelist.php
argadd articlelist.php
argadd category.php
argadd categoryarchive.php
argadd categorylist.php
argadd footer.php
argadd form.php
argadd formajax.php
