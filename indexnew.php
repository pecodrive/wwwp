...
<div class="panel panel-default">
    ...
    <div class="list panel-body">
        ...
        <div class="listpanel list-new panel-body col-xs-12 col-sm-6 col-md-6 col-lg-4">
            <a href="<?php the_permalink() ?>">
                <img class="imgBox" src="<?php get_image();?>">
                <img class="new" src="<?php echo get_template_directory_uri();?>/img/new.png">
                <div class="disBox"><div class="newdate"><?php echo get_the_date("Y/m/d h:m:s"); ?></div><div><?php the_title(); ?></div></div>
            </a>
        </div>
    <?php endwhile; ?>
